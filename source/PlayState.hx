...
class PlayState extends MusicBeatState
{
	...
	public var healthBack:FlxSprite;
	...
	override public function create()
	{
		...
		#if LUA_ALLOWED
		#if MODS_ALLOWED
		var luaToLoad:String = Paths.modFolders('stages/' + event + '.lua');
		...
		{
			luaToLoad = SUtil.getStorageDirectory() + Paths.getPreloadPath('stages/' + event + '.lua');
			if (FileSystem.exists(luaToLoad))
			{
				luaArray.push(new FunkinLua(luaToLoad));
			}
		...
		timeTxt.setFormat(Paths.font("GhostKidAOE.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("GhostKidAOE.otf"), 25, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("GhostKidAOE.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				switch (swagCounter)
				{
					...
					case 1:
						...
						FlxTween.tween(countdownGet, {/*y: countdownSet.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
							ease: FlxEase.cubeInOut,
							onComplete: function(twn:FlxTween)
							{
								remove(countdownGet);
				...
				if (storyPlaylist.length <= 0)
				{
					...
					{ // after the last song!!
						...
						if (FlxG.save.data.beatenMainWeek == null)
						{
							...
							trace("VIBE CHECK");
						} // makes a save thing when the main song
					}
					else
					{
